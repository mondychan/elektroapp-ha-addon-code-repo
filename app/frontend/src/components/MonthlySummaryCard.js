      ...
      <table className="data-table table-spaced">
        <thead>
          <tr>
            ...
            <th className="cell-right">Spotreba (kWh)</th>
            <th className="cell-right">Cena (Kc)</th>
          </tr>
        </thead>
        <tbody>
          {monthlySummary.map((day) => {
            ...
            return (
              <tr key={day.date}>
                ...
                <td className="cell-right">{day.cost_total == null ? "-" : day.cost_total.toFixed(2)}</td>
              </tr>
            );
          })}
        </tbody>
        {monthlyTotals && (
          <tfoot>
            <tr>
              ...
              <td className="cell-right">{monthlyTotals.cost_total?.toFixed(2)}</td>
            </tr>
          </tfoot>
        )}
      </table>
