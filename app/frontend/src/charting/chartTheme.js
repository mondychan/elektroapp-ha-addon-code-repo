...
export const getChartTheme = () => {
  ...
  return {
    ...
    accentBlue: readCssVar(styles, "--accent-blue", DEFAULT_THEME.accentBlue),
    accentCyan: readCssVar(styles, "--accent-cyan", DEFAULT_THEME.accentCyan),
    accentGreen: readCssVar(styles, "--accent-green", DEFAULT_THEME.accentGreen),
    accentAmber: readCssVar(styles, "--accent-amber", DEFAULT_THEME.accentAmber),
    accentRed: readCssVar(styles, "--accent-red", DEFAULT_THEME.accentRed),
    accentPurple: readCssVar(styles, "--accent-purple", DEFAULT_THEME.accentPurple),
