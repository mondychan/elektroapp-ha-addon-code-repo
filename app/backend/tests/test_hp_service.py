...
def test_hp_service_infers_power_measurements_and_falls_back_to_ha_state():
    ...
    assert captured_measurements[0] == ["sensor.ebusd_ha_daemon_hmu_powerconsumptionhmu", "ebusd_ha_daemon_hmu_powerconsumptionhmu", "W", "kW"]
...
def test_hp_service_preserves_celsius_measurement_case_for_series():
    ...
    assert captured_measurements[0] == ["sensor.ebusd_ha_daemon_broadcast_outsidetemp", "ebusd_ha_daemon_broadcast_outsidetemp", "°C", "°c"]
